...
public class ParallelGatewayTest {
    ...
    public void deploymentProcessDefinition(){
        InputStream in = this.getClass().getResourceAsStream("/diagrams/parallelGateway.bpmn");
        InputStream in1 = this.getClass().getResourceAsStream("/diagrams/parallelGateway.png");
        Deployment deployment = pe.getRepositoryService()//与流程定义和部署对象相关的Service
                .createDeployment()//创建一个部署对象
                .name("并行网关")//添加部署名称
                .addInputStream("parallelGateway.bpmn",in)//使用资源文件的名称
                .addInputStream("parallelGateway.png",in1)//使用资源文件的名称
                .deploy();//部署完成
